...
class MediaPlayer:
    ...
    def __init__(self):
        ...
        media_manager.new(r"(уменьши громкость до минимума|поставь звук на минимум|выставь минимальный уровень громкости|поставь звук на самый низкий уровень)")(self.minimum)
        media_manager.new(r"(звук на нуле|убавь громкость до конца|отключи звук|уменьши громкость до нуля)")(self.turn_off_the_sound)
        media_manager.new(r"(про песню|про трек|что сейчас играет|информация)")(self.get_info)

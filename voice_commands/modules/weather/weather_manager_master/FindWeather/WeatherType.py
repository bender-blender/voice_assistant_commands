...
sun_codes = [1000]
lit_precip_codes = [1063, 1066, 1072, 1135, 1150, 1153, 1180, 1183, 1189, 1186, 1198, 1210, 1213, 1216, 1219, 1240, 1255, 1261]
strong_precip_codes = [1114, 1117, 1168, 1147, 1171, 1192, 1195, 1201, 1207, 1222, 1225, 1237, 1243, 1246, 1252, 1258]
...
class WeatherType(str, Enum):
    ...
    # elif code in zombie_codes:
    #     return WeatherType.zombie
    # elif code in radio_codes:
    #     return WeatherType.radio
